...
- Auto-dispatches by kind:
  - **Text**: Opens an inline text editor sheet. On save, a new plain text history entry is created and becomes the Current Clipboard (original preserved).
